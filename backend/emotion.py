...
def emotion(score_container, frame_container, stop_event,stop_view):
    while not stop_event.is_set():
        ...
        # Read labels
        with open('emotion_detection/model/keypoint_classifier/keypoint_classifier_label.csv',
            ...
            d={}
            for i in keypoint_classifier_labels:
                d[i] = 0
            print(d)
        total = 1
        mode = 0
        ...
        while True:
            if stop_event.is_set() or stop_view:
                break
